...
//createpost({ title: 'post 3', body: 'yeah this is post 3' }) .then(function () {
...
//        });
//    });
Promise.all([createpost({ title: 'post 3', body: 'yeah this is post 3' }), updateLastUserActivityTime()]).then(()=>{
